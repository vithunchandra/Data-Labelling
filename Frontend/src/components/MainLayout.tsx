        ...
        <div className="w-100 h-100">
            <div className="row flex-nowrap h-100 g-0">
                <div className="col-auto">
                    <div id="sidebar" className="collapse collapse-horizontal bg-white show h-100 shadow">
                        <div id="sidebar-nav" className="d-flex flex-column h-100">
                            <div className="w-100 d-flex align-items-center justify-content-between ps-2 py-2 fs-3 fw-bold">
                                <div className="d-flex align-items-center fs-3 fw-bold">
                                    <img src={logo} className="me-2" style={{height: '45px'}}></img>
                                </div>
                                    ...
                                    navigation.map((item, index) => {
                                        return <Link to={item.path} className="text-decoration-none text-black" key={index}>
                                            ...
                                            >
                                                ...
                                                <ListItemText primaryTypographyProps={{color: 'black'}} primary={item.name}></ListItemText>
                                            </ListItemButton>
                                        </Link>
                                    })
                                }
                            ...
                            <List>
                                <ListItemButton onClick={() => {
                                    ...
                                    <ListItemText primary={'Log Out'} primaryTypographyProps={{fontWeight: 'bold', color: 'red', borderColor: 'blue'}}/>
                                </ListItemButton>
                            </List>
                            <div className='d-flex bg-primary text-white align-items-center py-3 px-2 border-top border-3 fs-6'>
                                Created By <span className="ms-1 d-inline-block"> @DatleTeams</span><br />
                            </div>
                        </div>
                    </div>
                </div>
